    ...
    <SafeAreaView style={styles.container}>
      <ScrollView contentContainerStyle={styles.scroll}>
        <View style={styles.hero}>
          ...
          <Text style={styles.subtitle}>Trollsländeobservationer i Sverige</Text>
        </View>
        ...
        <View style={styles.card}>
          ...
          <Text style={styles.cardBody}>
            ...
            släkte eller familj och se hur flygperioden varierar mellan år och platser.
          </Text>
        </View>
        ...
        <View style={styles.card}>
          ...
          <Text style={styles.cardBody}>
            Gå till fliken{' '}
            <Text style={styles.bold}>Fenologi</Text>
            {' '}för att utforska observationsdata. Välj en art eller ett högre
            taxon och filtrera på plats för att se flygperioden som ett histogram.
          </Text>
        </View>
        ...
        <View style={styles.card}>
          ...
          <Text style={styles.cardBody}>
            ...
            regelbundet. Endast imago-observationer (flygande vuxna individer) ingår.
          </Text>
        </View>
      </ScrollView>
    </SafeAreaView>
...
const styles = StyleSheet.create({
  ...
  title: {
    fontSize: 36, fontWeight: '800', color: '#023e8a', letterSpacing: 0.5,
  },
